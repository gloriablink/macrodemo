(function (blink) {
	...
	var macrodemoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	macrodemoStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_macrodemo',
		extraPlugins: ['image2'],
		ckEditorStyles: {
			name: 'macrodemo',
			styles: [
	...
	macrodemoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), macrodemoStyle.prototype);

	blink.theme.styles.macrodemo = macrodemoStyle;
...
$(document).ready(function () {
	...
	var src_logo = $('.content_type_clase_macrodemo').find('.logo_slide').attr('logo_dominio');
	if (typeof(src_logo) != 'undefined' && src_logo && src_logo != '' && src_logo.indexOf('gif1x1.gif') == -1) {
		$('.content_type_clase_macrodemo').find('.logo-publisher').css('background-image', "url('"+src_logo+"')");
	}
});
